...
export { toTokenCountInputSchema } from './util/to-json-schema'
...
export async function loopAgentSteps(
  ...
  // with inputSchema as plain JSON Schema (see toolDefinitions above).
  // Anthropic's count_tokens API expects [{ name, description, input_schema }]
  // with input_schema being real JSON Schema (with a top-level `type: 'object'`)
  // — see toTokenCountInputSchema.
